...
namespace Unity.GraphToolkit
{
    ...
    /// </summary>
    public struct TypeHandleDescriptor
    {
        /// <summary>
    ...
    public static class TypeHandleHelpers
    {
        ...
        // For tests only
        public static (Dictionary<string, TypeHandleDescriptor>, Dictionary<string, Type>) GetState()
        {
            return (s_CustomIdToTypeHandleInternal, s_CustomIdToType);
        }

        // For tests only
        public static void SetState((Dictionary<string, TypeHandleDescriptor>, Dictionary<string, Type>) state)
        {
        ...
        public static string ResolveMovedFromType(string identification)
        {
        ...
        public static bool IsCustomTypeHandle(this TypeHandle typeHandle)
        {
            return typeHandle.Identification != null && s_CustomIdToTypeHandleInternal.ContainsKey(typeHandle.Identification);
        }

        public static string GetFriendlyName_Internal(this TypeHandle typeHandle)
        {
