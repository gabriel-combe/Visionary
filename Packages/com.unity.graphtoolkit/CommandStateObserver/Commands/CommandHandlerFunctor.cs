...
namespace Unity.GraphToolkit.CSO
{
    ...
    [UnityRestricted]
    public delegate void CommandHandler<in TCommand>(TCommand command)
    ...
    /// <typeparam name="TCommand">The command type.</typeparam>
    [UnityRestricted]
    public delegate void CommandHandler<in TParam, in TCommand>(TParam param, TCommand command)
        where TCommand : ICommand;
    ...
    /// <typeparam name="TCommand">The command type.</typeparam>
    [UnityRestricted]
    public delegate void CommandHandler<in TParam1, in TParam2, in TCommand>(TParam1 param1, TParam2 param2, TCommand command)
        where TCommand : ICommand;
    ...
    /// <typeparam name="TCommand">The command type.</typeparam>
    [UnityRestricted]
    public delegate void CommandHandler<in TParam1, in TParam2, in TParam3, in TCommand>(TParam1 param1, TParam2 param2, TParam3 param3, TCommand command)
        where TCommand : ICommand;
    ...
    /// <typeparam name="TCommand">The command type.</typeparam>
    [UnityRestricted]
    public delegate void CommandHandler<in TParam1, in TParam2, in TParam3, in TParam4, in TCommand>(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TCommand command)
        where TCommand : ICommand;
    ...
    /// <typeparam name="TCommand">The command type.</typeparam>
    [UnityRestricted]
    public delegate void CommandHandler<in TParam1, in TParam2, in TParam3, in TParam4, in TParam5, in TCommand>(TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, TParam5 param5, TCommand command)
        where TCommand : ICommand;
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TParam, TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TParam1, TParam2, TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
        CommandHandlerUtilities.BindingState m_BindingState;
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TParam1, TParam2, TParam3, TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
        CommandHandlerUtilities.BindingState m_BindingState;
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TParam1, TParam2, TParam3, TParam4, TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
        CommandHandlerUtilities.BindingState m_BindingState;
    ...
    /// </summary>
    [UnityRestricted]
    public class CommandHandlerFunctor<TParam1, TParam2, TParam3, TParam4, TParam5, TCommand> : ICommandHandlerFunctor
        where TCommand : ICommand
    {
        CommandHandlerUtilities.BindingState m_BindingState;
