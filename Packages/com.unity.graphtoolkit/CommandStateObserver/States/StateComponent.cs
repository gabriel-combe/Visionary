...
namespace Unity.GraphToolkit.CSO
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class StateComponent<TUpdater> : IUndoableStateComponent, ISerializationCallbackReceiver
        where TUpdater : class, IStateComponentUpdater, new()
    {
        ...
        protected void SetUpdateType(UpdateType type)
        {
        ...
        // For tests only.
        public void ForceSetUpdateType(UpdateType type)
        {
            m_ScopeUpdateType = type;
        }
