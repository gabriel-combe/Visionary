...
namespace Unity.GraphToolkit.CSO
{
    ...
    /// </summary>
    [UnityRestricted]
    public abstract class ChangesetManager : IChangesetManager
    {
        ...
        public IChangeset LastChangeset => m_Changesets.Count > 0 ? m_Changesets[^ 1].Changeset : throw new InvalidOperationException("No changeset available.");
    ...
    [UnityRestricted]
    public sealed class ChangesetManager<TChangeset> : ChangesetManager where TChangeset : class, IChangeset, new()
    {
        /// <summary>
        /// The current changeset.
        /// </summary>
        ...
        // Used by tests.
        public new TChangeset LastChangeset => (TChangeset)base.LastChangeset;
