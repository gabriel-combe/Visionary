...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public static class ItemLibraryService
    {
        /// <summary>
        ...
        public static ItemLibraryWindow ShowDatabases(GraphView view,
            Vector2 position,
        ...
        public static ItemLibraryWindow ShowEnumValues(RootView view, string title, Type enumType, Vector2 position, Action<Enum, int> callback)
        {
            return ShowEnumValues(EditorWindow.focusedWindow, view, title, enumType, position, callback);
        }

        public static ItemLibraryWindow ShowEnumValues(EditorWindow host,
            RootView rootView,
            string title,
            Type enumType,
            Vector2 position,
        ...
        public static ItemLibraryWindow ShowValues(EditorWindow host, RootView rootView, Preferences preferences, string title, IReadOnlyList<ItemLibraryItem> items, Vector2 position,
            Action<string> callback)
        {
        ...
        public static ItemLibraryWindow ShowVariableTypes(EditorWindow host, RootView rootView, IItemDatabaseProvider itemDatabaseProvider, Type variableDeclarationType, Preferences preferences, Vector2 position, CreateVariableCallBack callback)
        {
        ...
        public static ItemLibraryWindow ShowTypes(EditorWindow host, RootView rootView, Preferences preferences, IEnumerable<ItemLibraryDatabaseBase> databases, Vector2 position, SetTypeCallBack callback)
        {
            if (rootView is not IHasItemLibrary hasItemLibrary)
                return null;
        ...
        public static IEnumerable<ItemLibraryDatabaseBase> GetItemLibraryDatabasesForNodes(IItemDatabaseProvider dbProvider, IReadOnlyList<PortModel> portModels)
        {
