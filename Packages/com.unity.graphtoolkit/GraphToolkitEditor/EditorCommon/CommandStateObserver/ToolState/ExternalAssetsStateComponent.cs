...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ExternalAssetsStateComponent : StateComponent<ExternalAssetsStateComponent.StateUpdater>
    {
        [UnityRestricted]
        public class StateUpdater : BaseUpdater<ExternalAssetsStateComponent>
        {
            /// <summary>
