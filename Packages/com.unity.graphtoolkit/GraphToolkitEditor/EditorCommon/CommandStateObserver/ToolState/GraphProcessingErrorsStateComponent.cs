...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public class GraphProcessingErrorsStateComponent : StateComponent<GraphProcessingErrorsStateComponent.StateUpdater>
    {
        /// <summary>
        /// The updater for <see cref="GraphProcessingErrorsStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        public class StateUpdater : BaseUpdater<GraphProcessingErrorsStateComponent>, IOnGraphLoaded
        {
            /// <summary>
            /// Sets the error list.
            /// </summary>
