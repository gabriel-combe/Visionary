...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public sealed class UndoStateRecorder : ScriptableObject, ISerializationCallbackReceiver, IUndoableCommandMerger
    {
        [Serializable]
        ...
        public void PurgeAllChangesets()
        {
        ...
        public static UndoStateRecorder GetStateRecorder(Type graphToolType)
        {
        ...
        public const int purgeTrigger = 200;
        ...
        public static void ClearNeedToRestore()
        {
        ...
        public bool CleanupMergingInternal()
        {
