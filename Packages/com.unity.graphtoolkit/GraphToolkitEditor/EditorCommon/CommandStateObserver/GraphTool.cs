...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class GraphTool : CsoTool, IHierarchicalCommandTarget
    {
        /// <summary>
        ...
        /// <returns>The newly created tool.</returns>
        public static TGraphTool Create<TGraphTool, TClipboardProvider>(Hash128 windowID)
            where TGraphTool : GraphTool, new()
        ...
        /// </summary>
        public virtual bool SupportsMultipleWindows => true;

        public bool WantsTransientPrefs { get; set; }
        ...
        public string LastDispatchedCommandName => (Dispatcher as CommandDispatcher)?.LastDispatchedCommandName;
        ...
        public ToolbarDefinition GetToolbarDefinition(Toolbar toolbar)
        {
