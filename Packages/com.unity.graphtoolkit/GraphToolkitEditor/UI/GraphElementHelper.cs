...
namespace Unity.GraphToolkit.Editor
{
    ...
    public static class GraphElementHelper
    {
        ...
        public static void AddStylesheet(this VisualElement ve, string stylesheetName, string path)
        {
        ...
        public static void AddStyleSheetPath(this VisualElement ve, string stylesheetPath)
        {
            if (ve == null)
                return;
