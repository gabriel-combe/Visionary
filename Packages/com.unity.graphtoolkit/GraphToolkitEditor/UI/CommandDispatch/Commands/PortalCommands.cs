...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateOppositePortalCommand : ModelCommand<WirePortalModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class RevertPortalsToWireCommand : ModelCommand<WirePortalModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class RevertAllPortalsToWireCommand : ModelCommand<WirePortalModel>
    {
