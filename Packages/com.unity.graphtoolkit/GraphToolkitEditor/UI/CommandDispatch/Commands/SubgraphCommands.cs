...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateLocalSubgraphFromSelectionCommand : UndoableCommand
    {
        /// <summary>
        /// The GraphView.
        /// </summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateSubgraphNodeFromExistingGraphCommand : UndoableCommand
    {
        /// <summary>
    ...
    [UnityRestricted]
    public class ConvertAssetToLocalSubgraphCommand : UndoableCommand
    {
        /// <summary>
    ...
    [UnityRestricted]
    public class ConvertLocalToAssetSubgraphCommand : UndoableCommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ExpandSubgraphCommand : UndoableCommand
    {
        /// <summary>
