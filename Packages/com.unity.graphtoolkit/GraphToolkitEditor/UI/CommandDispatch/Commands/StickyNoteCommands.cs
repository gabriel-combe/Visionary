...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class UpdateStickyNoteThemeCommand : ModelCommand<StickyNoteModel, string>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class UpdateStickyNoteTextSizeCommand : ModelCommand<StickyNoteModel, string>
    {
