...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateWireCommand : UndoableCommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class MoveWireCommand : ModelCommand<WireModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class DeleteWireCommand : ModelCommand<WireModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ReorderWireCommand : UndoableCommand
    {
        /// <summary>
        /// The wire to reorder.
        /// </summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class SplitWireAndInsertExistingNodeCommand : UndoableCommand
    {
        public readonly WireModel WireModel;
    ...
    /// </summary>
    [UnityRestricted]
    public class ConvertWiresToPortalsCommand : UndoableCommand
    {
