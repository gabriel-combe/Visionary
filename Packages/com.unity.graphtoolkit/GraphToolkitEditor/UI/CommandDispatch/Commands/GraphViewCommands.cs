...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class MoveElementsAndBringPlacematToFrontCommand : MoveElementsCommand
    {
        ...
        public static void BringPlacematsToFront(IReadOnlyList<(PlacematModel, PlacematModel)> placematModelsToBringInFrontOf)
        {
    ...
    /// </summary>
    [UnityRestricted]
    public class DeleteElementsCommand : ModelCommand<GraphElementModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class PasteDataCommand : UndoableCommand
    {
        /// <summary>
