...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateSingleStateTransitionSupportCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateTransitionSupportCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class CreateStateFromTransitionCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class MoveTransitionSupportCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class PasteSingleStateTransitionSupportsCommand : UndoableCommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class PasteTransitionSupportsCommand : UndoableCommand
    {
        /// <summary>
