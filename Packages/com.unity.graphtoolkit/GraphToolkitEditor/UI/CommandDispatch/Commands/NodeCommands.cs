...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class CollapseNodeCommand : ModelCommand<AbstractNodeModel, bool>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ShowNodePreviewCommand : ModelCommand<AbstractNodeModel, bool>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class RenameElementsCommand : UndoableCommand
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class UpdateConstantsValueCommand : UndoableCommand
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class DisconnectWiresCommand : ModelCommand<AbstractNodeModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class DisconnectWiresOnPortCommand : ModelCommand<PortModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class BypassNodesCommand : ModelCommand<AbstractNodeModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ChangeNodeStateCommand : ModelCommand<AbstractNodeModel, ModelState>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ChangeNodeModeCommand : UndoableCommand
    {
        /// <summary>
