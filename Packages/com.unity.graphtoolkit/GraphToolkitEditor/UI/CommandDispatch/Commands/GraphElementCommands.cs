...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ResetElementColorCommand : ModelCommand<GraphElementModel>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ChangeElementColorCommand : ModelCommand<GraphElementModel, Color>
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class DisplayInInspectorCommand : ICommand
    {
        [UsedImplicitly]
    ...
    /// </summary>
    [UnityRestricted]
    public class SelectElementsCommand : ModelCommand<GraphElementModel>
    {
        /// <summary>
        /// Selection mode.
        /// </summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class ChangePlacematLayoutAndBringPlacematToFrontCommand : ChangeElementLayoutCommand
    {
