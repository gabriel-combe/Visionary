...
namespace Unity.GraphToolkit.Editor
{
    ...
    public static class ViewForModel
    {
        ...
        public static void AddOrReplaceModelView(ModelView modelView)
        {
            s_ViewForModel.AddOrReplaceViewForModel(modelView);
        }

        public static void AddOrReplaceModelView(MultipleModelsView modelView)
        {
            s_ViewForModel.AddOrReplaceViewForModel(modelView);
        }

        [CanBeNull]
        public static ChildView GetView(this Model model, RootView view, IViewContext context = null)
        {
        ...
        [CanBeNull]
        public static ChildView GetView(this Hash128 modelGuid, RootView view, IViewContext context = null)
        {
        ...
        public static IEnumerable<ChildView> GetAllViews(this IEnumerable<Model> models, RootView view,
        ...
        public static void GetAllViewsRecursively(this IEnumerable<Model> models, RootView view,
            Predicate<ChildView> filter, List<ChildView> outViewList)
        {
            outViewList.Clear();
        ...
        public static void RemoveModelView(ModelView modelView)
        {
            s_ViewForModel.RemoveModelView(modelView);
        }

        public static void RemoveModelView(MultipleModelsView modelView)
        {
            s_ViewForModel.RemoveModelView(modelView);
        }
        ...
        public static void Reset(RootView rootView)
        {
