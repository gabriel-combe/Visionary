...
namespace Unity.GraphToolkit.Editor
{
    ...
    public static class VisualElementExtensions
    {
        ...
        public static VisualElement GetFirstAncestorWhere(this VisualElement ve, Predicate<VisualElement> predicate)
        {
        ...
        /// </summary>
        /// <param name="ve"></param>
        public static void MakeElementCapturePointer(this VisualElement ve)
        {
