...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class Blackboard : BlackboardElement, IHasContextualMenuItems
    {
        /// <summary>
        ...
        public void DoRefresh(bool shouldRebuild = false)
        {
            if (!m_WaitingForRefresh)
                return;
        ...
        public void RefreshGroup(GroupModelBase group)
        {
