...
namespace Unity.GraphToolkit.Editor
{
    ...
    [UnityRestricted]
    public class VariableQuickSettingsAttribute : Attribute
    {
    }
    ...
    [AttributeUsage(AttributeTargets.Field)]
    [UnityRestricted]
    public class VariableAdvancedAttribute : Attribute
    {
    }
    ...
    /// </summary>
    [UnityRestricted]
    public static class DisplayFlagsExtensions
    {
        /// <summary>
    ...
    /// </summary>
    [UnityRestricted]
    public class VariableFieldsInspector : GraphElementFieldInspector
    {
