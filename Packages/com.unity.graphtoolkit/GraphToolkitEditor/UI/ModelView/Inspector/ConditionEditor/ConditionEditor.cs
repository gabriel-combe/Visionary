...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ConditionEditorContext : IViewContext
    {
    ...
    /// </summary>
    [UnityRestricted]
    public class ConditionEditor : ModelView
    {
        ...
        /// </summary>
        public TransitionSelectionManager<ConditionView> SelectionManager => m_SelectionManager;
