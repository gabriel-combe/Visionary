...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class GroupConditionView : ConditionView
    {
        /// <summary>
        ...
        public void StartBlockHoveringOver()
        {
        ...
        public void BlockHoveringOver(Vector2 posInContext, IReadOnlyList<ConditionView> conditions)
        {
            if (SubConditions.Count > 0)
            {
        ...
        public void BlockDropped(Vector2 posInContext, IReadOnlyList<ConditionView> conditions)
        {
            var index = GetBlockIndex(posInContext);
        ...
        public void StopBlockHoveringOver()
        {
        ...
        public Vector2 WorldToContainer(Vector2 worldPosition)
        {
