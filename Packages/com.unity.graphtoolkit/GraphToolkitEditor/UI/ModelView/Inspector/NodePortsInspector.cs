...
namespace Unity.GraphToolkit.Editor
{
    ...
    public class NodePortsInspector : FieldsInspector
    {
        ...
        public ModelInspectorStateComponent ModelInspectorState => (m_OwnerElement.RootView as ModelInspectorView)?.ModelInspectorViewModel.ModelInspectorState;
        /// <summary>
        ...
        static public bool ShouldRebuildField(BaseModelPropertyField field, List<PortModel> ports)
        {
        ...
        public BaseModelPropertyField CreatePortEditor(List<PortModel> ports)
        {
        ...
        public void RefreshExpandablePortsFieldCollapse(HashSet<string> changeSetPortUniqueNameChanged)
        {
