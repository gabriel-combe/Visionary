...
namespace Unity.GraphToolkit.Editor
{
    ...
    {
        // public for tests
        public static Dictionary<Type, Type> wrapperTypes = new(); // Value type to wrapper type (eg: MyType to UnityEditor.GraphToolsFoundation.WrapperTypes.Wrapper_MyType_{s_UniqueId++}).
        public static ConditionalWeakTable<object, List<(string, FieldWrapper)>> objectWrappers = new(); // Associates a list of wrappers to a model (eg: all wrappers associated with a node). As long as the key is alive, the value stays alive.
        ...
        public static CustomPropertyDrawerAdapter Create(IReadOnlyList<Constant> constants, ICommandTarget commandTargetView)
        {
        ...
        public static CustomPropertyDrawerAdapter Create(string fieldName, ICommandTarget commandTargetView, IReadOnlyList<Model> owners)
        {
        ...
        public bool UpdateDisplayedValue(object value)
        {
        ...
        /// </remarks>
        public VisualElement Build(string labelText)
        {
        ...
        public static void RemoveCommandTarget(ICommandTarget commandTarget)
        {
