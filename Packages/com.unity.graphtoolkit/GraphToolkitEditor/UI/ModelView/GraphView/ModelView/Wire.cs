...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class Wire : AbstractWire, IShowItemLibraryUI
    {
        /// <summary>
        ...
        public override VisualElement SizeElement => WireControl;
        ...
        public static List<(WireModel, Vector2, Vector2)> GetPortalsWireData(IEnumerable<WireModel> wires, RootView rootView)
        {
