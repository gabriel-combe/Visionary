...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class Placemat : GraphElement, IResizeListener
    {
        ...
        public static readonly float k_SmartResizeMargin = 37.0f;
        ...
        public bool ActOnGraphElementsInside(Func<GraphElement, bool> act)
        {
        ...
        public Rect ComputeShrinkToFitElementsRect()
        {
        ...
        public void GetElementsToMove(bool moveOnlyPlacemat, HashSet<GraphElement> collectedElementsToMove)
        {
        ...
        public static bool ComputeElementBounds(VisualElement reference, ref Rect pos, List<GraphElement> elements)
        {
