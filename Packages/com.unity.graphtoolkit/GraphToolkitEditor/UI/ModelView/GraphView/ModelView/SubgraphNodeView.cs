...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class SubgraphNodeView : CollapsibleInOutNodeView
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        protected override int NodeTitleOptions => EditableTitlePart.Options.SetWidth | NodeTitlePart.Options.ShouldDisplayColor | NodeTitlePart.Options.HasIcon | EditableTitlePart.Options.UseEllipsis;
        ...
        public static void DrawSubgraphTab(Painter2D p2d, Rect tabRect, Rect bottomRect, Vector2 brr = default, Vector2 blr = default)
        {
            const int radius = 3;
