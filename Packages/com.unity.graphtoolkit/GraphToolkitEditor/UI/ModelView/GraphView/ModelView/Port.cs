...
namespace Unity.GraphToolkit.Editor
{
    ...
    public class Port : ModelView, ISelectionDraggerTarget
    {
        ...
        public static void OnGenerateExecutionConnectorVisualContent(MeshGenerationContext mgc, Color portColor, PortOrientation orientation, Rect connectorRect, bool isCapVisible)
        {
