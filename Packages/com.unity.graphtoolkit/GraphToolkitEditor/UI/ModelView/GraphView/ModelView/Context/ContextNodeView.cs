...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ContextNodeView : CollapsibleInOutNodeView, IShowItemLibraryUI
    {
        /// <summary>
        ...
        public static readonly CustomStyleProperty<Color> BlocksBorderColorStyle = new CustomStyleProperty<Color>("--blocks--border-color");
        ...
        protected override int NodeTitleOptions => NodeTitlePart.Options.HasIcon;
        ...
        public void StartBlockDragging(float blocksHeight)
        {
        ...
        public void BlockDraggingRefused()
        {
        ...
        public void BlocksDragging(Vector2 posInContext, IEnumerable<BlockNodeModel> blocks, bool copy)
        {
            var blockContainer = ContextBlocksRoot;
            if (blockContainer == null)
                return;
        ...
        public void BlocksDropped(Vector2 posInContext, IEnumerable<BlockNodeModel> blocks, bool copy)
        {
            int index = GetBlockIndex(posInContext);
        ...
        public bool ShowItemLibrary(Vector2 mousePosition, int index)
        {
