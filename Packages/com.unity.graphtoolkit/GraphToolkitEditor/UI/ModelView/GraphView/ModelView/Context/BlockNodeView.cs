...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class BlockNodeView : CollapsibleInOutNodeView
    {
        /// <summary>
        ...
        public static readonly CustomStyleProperty<Color> BlocksBackgroundColorStyle = new CustomStyleProperty<Color>("--block--background-color");
        public static readonly CustomStyleProperty<Color> DisabledBackgroundColorStyle = new CustomStyleProperty<Color>("--disabled-background-color");
        public static readonly CustomStyleProperty<float> BlockBorderStyle = new CustomStyleProperty<float>("--block--border");
        ...
        protected override int NodeTitleOptions => EditableTitlePart.Options.ClickToEditDisabled;
        ...
        public static void Inset(ref Rect r, Vector2 inset)
        {
            r.position += inset;
            r.size -= inset * 2.0f;
        }
        ...
        public static void DrawBlock(ref Rect r, Painter2D p2d, bool displayEtch, bool isLast, bool isFirst, bool isColorLine, ref BlockDrawParams drawParams)
        {
