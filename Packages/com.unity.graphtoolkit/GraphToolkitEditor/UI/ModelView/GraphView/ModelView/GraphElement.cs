...
namespace Unity.GraphToolkit.Editor
{
    ...
    public abstract class GraphElement : ModelView
    {
        ...
        public virtual VisualElement SizeElement => this;
        ...
        public void OnRenameKeyDown(KeyDownEvent e)
        {
            if (IsRenameKey(e))
            {
        ...
        public bool SetCullingState(GraphViewCullingState state, GraphViewCullingSource cullingSource)
        {
        ...
        /// <returns>Whether the actual culling state changed because of this operation.</returns>
        public bool SetCullingState(GraphViewCullingState state, IReadOnlyList<GraphViewCullingSource> cullingSources)
        {
