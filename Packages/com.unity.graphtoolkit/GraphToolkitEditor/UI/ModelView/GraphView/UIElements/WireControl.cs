...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class WireControl : VisualElement
    {
        ...
        public PortOrientation ToOrientation
        {
            get => m_ToOrientation;
            set => m_ToOrientation = value;
        }

        public PortOrientation FromOrientation
        {
        ...
        public PortDirection FromDirection
        {
            get => m_FromDirection;
            set => m_FromDirection = value;
        }
        public PortDirection ToDirection
        {
            get => m_ToDirection;
