...
namespace Unity.GraphToolkit.Editor
{
    ...
    public interface IShortcutContextHandler
    {
    ...
    public class ShortcutEventBase<T> : EventBase<T>, IShortcutEvent where T : ShortcutEventBase<T>, new()
    {
        ...
        public static string GetShortcutString(GraphTool tool)
        {
            var attribute = typeof(T).GetCustomAttribute<ToolShortcutEventAttribute>();
            if (attribute != null && (attribute.ToolName == null || attribute.ToolName == tool.Name))
            {
        ...
        public static string GetMenuItemShortcutString(GraphTool tool)
        {
            var attribute = typeof(T).GetCustomAttribute<ToolShortcutEventAttribute>();
            if (attribute != null && (attribute.ToolName == null || attribute.ToolName == tool.Name))
            {
        ...
        public static string GetMenuItemName(GraphTool tool)
        {
            var attribute = typeof(T).GetCustomAttribute<ToolShortcutEventAttribute>();
            if (attribute != null && (attribute.ToolName == null || attribute.ToolName == tool.Name))
            {
        ...
        public static void SendTestEvent(GraphViewEditorWindow window, ShortcutStage stage)
        {
