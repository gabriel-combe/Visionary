...
namespace Unity.GraphToolkit.Editor
{
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutToggleBlackboardEvent : ShortcutEventBase<ShortcutToggleBlackboardEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutToggleInspectorEvent : ShortcutEventBase<ShortcutToggleInspectorEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutToggleMinimapEvent : ShortcutEventBase<ShortcutToggleMinimapEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutConvertWireToPortalEvent : ShortcutEventBase<ShortcutConvertWireToPortalEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutCreateLocalSubgraphFromSelectionEvent : ShortcutEventBase<ShortcutCreateLocalSubgraphFromSelectionEvent>
    {
    ...
    */
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutDisconnectWiresEvent : ShortcutEventBase<ShortcutDisconnectWiresEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutToggleNodeCollapseEvent : ShortcutEventBase<ShortcutToggleNodeCollapseEvent>
    {
    ...
    [ToolShortcutEvent(null, id, k_KeyCode, k_Modifiers)]
    [UnityRestricted]
    public class ShortcutExtractContentsToPlacematEvent : ShortcutEventBase<ShortcutExtractContentsToPlacematEvent>
    {
