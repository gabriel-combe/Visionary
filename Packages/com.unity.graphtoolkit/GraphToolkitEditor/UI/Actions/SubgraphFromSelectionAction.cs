...
namespace Unity.GraphToolkit.Editor
{
    ...
    {
        static public readonly SubgraphFromSelectionActionData InvalidData
            = new SubgraphFromSelectionActionData() { IsValid = false };

        public struct SubgraphFromSelectionActionData
        {
            public bool IsValid;
        ...
        public static SubgraphFromSelectionActionData CollectData(GraphView view, Type graphObjectType, Type graphModelType)
        {
