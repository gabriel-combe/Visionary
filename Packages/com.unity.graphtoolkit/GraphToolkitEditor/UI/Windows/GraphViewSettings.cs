...
namespace Unity.GraphToolkit.Editor
{
    ...
    public static class GraphViewSettings
    {
        ...
        public static readonly bool PanUsePercentage = true;
        public const EasingFunction panEasingFunction = EasingFunction.InOutQuad;
        public const float panAreaSize = 5f;
        public const float panMinSpeedFactor = 0.2f;
        public const float panMaxSpeedFactor = 1.75f;
