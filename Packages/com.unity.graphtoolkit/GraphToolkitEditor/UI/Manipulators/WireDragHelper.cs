...
namespace Unity.GraphToolkit.Editor
{
    ...
    public class WireDragHelper
    {
        ...
        public static void EnableAllWires(GraphView graphView, bool isEnabled = true, List<WireModel> exemptedWires = null)
        {
        ...
        public void GetCompatiblePorts(Predicate<PortModel> compatiblePortsFilter = null)
        {
        ...
        public void HighlightCompatiblePorts()
        {
        ...
        public void StopHighlightingCompatiblePorts()
        {
            for (var i = 0; i < m_AllPorts.Count; i++)
            {
                var pv = m_AllPorts[i].GetView<Port>(GraphView);
