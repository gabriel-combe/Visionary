...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class WireConnector : MouseManipulator
    {
        /// <summary>
        /// The wire helper for this connector.
        /// </summary>
        /// <remarks>Internally settable for tests.</remarks>
        public WireDragHelper WireDragHelper { get; set; }

        public const float wireCreationDistanceThreshold = WireUtilities.WireCreationDistanceThreshold;
