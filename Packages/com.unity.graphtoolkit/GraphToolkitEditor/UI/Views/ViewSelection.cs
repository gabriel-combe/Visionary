...
namespace Unity.GraphToolkit.Editor
{
    ...
    public abstract class ViewSelection
    {
        ...
        public void PopulateMenuActionMap(Dictionary<string, Action> menuActionMap, ContextualMenuPopulateEvent evt)
        {
        ...
        public void AppendCopyPortValueMenuItem(ContextualMenuPopulateEvent evt, PortModel portModel)
        {
        ...
        public void AppendPastePortValueMenuItem(ContextualMenuPopulateEvent evt, PortModel portModel)
        {
            using var copyPasteData = m_ClipboardProvider.DeserializeDataFromClipboard();
            var canPaste = false;
