...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class GraphView : RootView, IDragSource, IHasItemLibrary, IHasContextualMenuItems
    {
        ...
        public PositionDependenciesManager PositionDependenciesManager { get; }
        ...
        /// <summary>
        /// Base speed for panning, made public to disable panning in tests.
        /// </summary>
        public static float BasePanSpeed { get; set; } = 0.4f;
        public const int panIntervalMs = 10; // interval between each pan in milliseconds
        public static float MinPanSpeed => GraphViewSettings.panMinSpeedFactor * BasePanSpeed;
        public static float MaxPanSpeed => GraphViewSettings.panMaxSpeedFactor * BasePanSpeed;

        /// <summary>
        /// Whether the graph must frame all graph elements when it is first loaded. Internal to allow to disable in tests.
        /// </summary>
        public static bool ShouldFrameAllOnFirstLoad = true;
        ...
        public static float GetPanSpeed(float distanceRatio)
        {
        ...
        public static float GetPanBorderSize(Vector2 viewSize)
        {
        ...
        public static Vector2 GetPanSpeed(Vector2 mousePos, Vector2 viewSize)
        {
        ...
        public Vector2 GetEffectivePanSpeed(Vector2 worldMousePos)
        {
        ...
        public void ChangeLayer(GraphElement element)
        {
        ...
        public void OnValidateCommand(ValidateCommandEvent evt)
        {
        ...
        public void OnExecuteCommand(ExecuteCommandEvent evt)
        {
            if (panel.GetCapturingElement(PointerId.mousePointerId) != null)
                return;
        ...
        */
        ...
        public bool CreateWireUI(WireModel wire)
        {
            if (wire == null)
                return false;
        ...
        public void UpdateBordersOnFocus(bool hasFocus)
        {
        ...
        /// </summary>
        protected virtual void RebuildSpacePartitioning() //public for tests
        {
            ClearSpacePartitioning();
        ...
        protected enum SpacePartitioningType
        {
            General,
            PlacematLayout,
            PlacematBoundingBox
