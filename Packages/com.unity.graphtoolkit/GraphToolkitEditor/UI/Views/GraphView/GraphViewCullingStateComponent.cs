...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class GraphViewCullingStateComponent : StateComponent<GraphViewCullingStateComponent.StateUpdater>
    {
        /// <summary>
        /// State updater for <see cref="GraphViewCullingStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        public class StateUpdater : BaseUpdater<GraphViewCullingStateComponent>
        {
            /// <summary>
