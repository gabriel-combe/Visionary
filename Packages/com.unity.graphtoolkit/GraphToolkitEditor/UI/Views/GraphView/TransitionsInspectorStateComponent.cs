...
namespace Unity.GraphToolkit.Editor
{
    [Serializable]
    [UnityRestricted]
    public class TransitionInspectorStateComponent : PersistedStateComponent<TransitionInspectorStateComponent.StateUpdater>
    {
        [Serializable]
        ...
        /// </summary>
        [UnityRestricted]
        public class StateUpdater : BaseUpdater<TransitionInspectorStateComponent>, IOnGraphLoaded
        {
            /// <summary>
