...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public class BlackboardContentStateComponent : StateComponent<BlackboardContentStateComponent.StateUpdater>
    {
        /// <summary>
        /// The updater for <see cref="BlackboardContentStateComponent"/>.
        /// </summary>
        [UnityRestricted]
        public class StateUpdater : BaseUpdater<BlackboardContentStateComponent>
        {
