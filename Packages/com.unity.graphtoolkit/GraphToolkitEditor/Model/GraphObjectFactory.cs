...
namespace Unity.GraphToolkit.Editor
{
    static class GraphObjectFactory
    {
        ...
        public static bool IsNativeAssetExtension(string extension)
        {
            return extension == k_NativeAssetExtension;
        }

        public static bool FilePathHasNativeAssetExtension(string filePath)
        {
        ...
        public static Type GetWindowTypeForGraphObject(Type graphObjectType)
        {
        ...
        public static bool KnowsExtension(string extension)
        {
