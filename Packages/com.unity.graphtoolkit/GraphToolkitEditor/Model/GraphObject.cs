...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class GraphObject : ScriptableObject, ISerializationCallbackReceiver, IObjectClonedCallbackReceiver
    {
        ...
        public bool IsSubAsset => m_IsSubAsset;

        public bool IsLocalSubgraphMigrated;
        ...
        public bool IsSaveAndLoadManagedByAssetDatabase
        {
            get
            {
                if (m_AssetGuid == default)
        ...
        /// </summary>
        [MenuItem("public:GraphToolkit/Load and Save All Graph Assets")]
        ...
        /// </summary>
        public void RemoveObsoleteSubgraphAssets()
        {
        ...
        public void AfterLoadForeignAsset(GUID assetGuid)
        {
        ...
        public bool CheckHasChangedOnDisk()
        {
...
#if !GTK_DISABLE_MIGRATION
        [MenuItem("public:GraphToolkit/Migrate .asset GraphObject Files")]
        public static void MigrateNativeAssetFiles()
        {
        ...
        [MenuItem("public:GraphToolkit/Migrate GraphObject Files with other extensions")]
        public static void MigrateGraphObjectFiles()
        {
