...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class PortNodeModel : AbstractNodeModel
    {
        /// <inheritdoc />
        ...
        protected virtual void UpdateConstantForInput(PortModel inputPort, Action<Constant> initializationCallback = null, Action<object> setterAction = null) {}
        ...
        public virtual void OnPortDataTypeChanged(PortModel portModel, TypeHandle previousType, TypeHandle dataTypeHandle) {}
    }
}
