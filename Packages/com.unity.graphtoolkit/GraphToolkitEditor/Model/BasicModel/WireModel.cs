...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public static class WireSideExtensions
    {
        /// <summary>
    ...
    [Serializable]
    [UnityRestricted]
    public class WireModel : GraphElementModel, IPortWireIndexModel
    {
        ...
        public static string fromPortReferenceFieldName = nameof(m_FromPortReference);
        public static string toPortReferenceFieldName = nameof(m_ToPortReference);
