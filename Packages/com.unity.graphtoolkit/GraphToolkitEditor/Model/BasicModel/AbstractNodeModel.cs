...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class AbstractNodeModel : GraphElementModel, IHasTitle, IMovable, IHasElementColor, IHasContextualMenuItems
    {
        ...
        public static string titleFieldName = nameof(m_Title);
        public static string positionFieldName = nameof(m_Position);
