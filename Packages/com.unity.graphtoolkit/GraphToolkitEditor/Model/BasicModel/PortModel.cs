...
namespace Unity.GraphToolkit.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class PortModel : GraphElementModel, IHasTitle, IPort
    {
        /// <summary>
        ...
        public void SetAttributes(IReadOnlyList<Attribute> attributes)
        {
        ...
        public static string ComputeUniqueName(string uniqueId, string title, Hash128 guid, string parentPortUniqueName)
        {
        ...
        public Constant ComputedConstant
        {
        ...
        public static Hash128 ComputePortHash(PortNodeModel nodeModel, PortDirection direction, string portName, PortType portType, TypeHandle dataType, string portId, PortModel parentPort)
        {
        ...
        public string ComputePortLabel(bool full)
        {
            if (ParentPort == null)
                return Title;
