...
namespace Unity.GraphToolkit.Editor
{
    ...
    [UnityRestricted]
    public class GraphAssetReference : ISerializationCallbackReceiver, IEquatable<GraphAssetReference>
    {
#if UGTK_INSTANCE_ID
        ...
        public static GraphObject Load(string path, long localFileId, GUID assetGuid)
        {
            if (localFileId == 0L)
