...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class NodeModel : InputOutputPortsNodeModel, ICollapsible
    {
        /// <summary>
        ...
        /// </summary>
        [UnityRestricted]
        public class NodeDefinitionScope: IPortsDefinition, IOptionsDefinition
        {
        ...
        /// <remarks>CreatePort will be called only if <see cref="GetReusablePort"/> returns null.</remarks>
        public PortModel AddInputPort(string portName, TypeHandle dataType, PortType portType = null,
            string portId = null, PortOrientation orientation = PortOrientation.Horizontal,
            PortModelOptions options = PortModelOptions.Default, Attribute[] attributes = null, Action<Constant> initializationCallback = null, Action<object> setterAction = null)
        {
        ...
        public PortModel AddOutputPort(string portName, TypeHandle dataType, PortType portType = null,
            string portId = null, PortOrientation orientation = PortOrientation.Horizontal,
            PortModelOptions options = PortModelOptions.Default, Attribute[] attributes = null)
        {
        ...
        public override void OnPortDataTypeChanged(PortModel portModel, TypeHandle previousType, TypeHandle dataTypeHandle)
        {
            if (!m_InDefineNode)
            {
                RedefinePort(portModel);
        ...
        protected override void UpdateConstantForInput(PortModel inputPort, Action<Constant> initializationCallback = null, Action<object> setterAction = null)
        {
        ...
        public void SetConstantForPort(string inputId, Constant newConstant)
        {
