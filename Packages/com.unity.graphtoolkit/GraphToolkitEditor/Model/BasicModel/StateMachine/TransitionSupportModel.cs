...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public enum TransitionSupportKind
    {
        /// <summary>
    ...
    [Serializable]
    [UnityRestricted]
    public class TransitionSupportModel : WireModel, IRenamable, IHasTitle, IGraphElementContainer, IHasElementColor
    {
        [SerializeField]
        [HideInInspector]
        [FormerlySerializedAs("m_FromStateAnchorSide")]
        public AnchorSide m_FromNodeAnchorSide;

        [SerializeField]
        [HideInInspector]
        [FormerlySerializedAs("m_FromStateAnchorOffset")]
        public float m_FromNodeAnchorOffset;

        [SerializeField]
        [HideInInspector]
        [FormerlySerializedAs("m_ToStateAnchorSide")]
        public AnchorSide m_ToNodeAnchorSide;

        [SerializeField]
        [HideInInspector]
        [FormerlySerializedAs("m_ToStateAnchorOffset")]
        public float m_ToNodeAnchorOffset;
