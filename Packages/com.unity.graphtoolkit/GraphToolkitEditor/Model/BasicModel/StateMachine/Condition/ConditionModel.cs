...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class ConditionModel : GraphElementModel, IHasTitle
    {
        [SerializeField]
        string m_Title;
        ...
        /// </remarks>
        public static string GetIndentationString(int indentLevel)
        {
        ...
        public void SetParent(GroupConditionModel parent)
        {
            Parent = parent;
