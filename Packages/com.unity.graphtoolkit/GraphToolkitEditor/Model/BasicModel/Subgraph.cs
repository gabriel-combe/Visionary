...
namespace Unity.GraphToolkit.Editor
{
    ...
    [UnityRestricted]
    public class Subgraph : ISerializationCallbackReceiver
    {
#if UGTK_INSTANCE_ID
...
#if UGTK_INSTANCE_ID
        public Subgraph(GUID assetGuid, long assetLocalId, InstanceID instanceID)
#else
        public Subgraph(GUID assetGuid, long assetLocalId, int instanceID)
#endif
        {
        ...
        public GraphModel GetGraphModelWithoutLoading() => m_GraphAsset != null ? m_GraphAsset.GraphModel : null;
        public GraphObject GetGraphAssetWithoutLoading() => m_GraphAsset;
