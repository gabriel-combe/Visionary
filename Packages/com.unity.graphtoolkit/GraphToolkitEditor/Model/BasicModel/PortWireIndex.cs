...
{
    public interface IPortWireIndexModel
    {
    ...
    /// </remarks>
    public class PortWireIndex<TWire> where TWire : class, IPortWireIndexModel
    {
        /// <summary>
        ...
        public class TestAccess<TTestWire> where TTestWire : class, IPortWireIndexModel
        {
