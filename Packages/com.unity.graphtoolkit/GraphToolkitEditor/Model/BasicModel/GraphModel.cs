...
namespace Unity.GraphToolkit.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract partial class GraphModel : Model, IGraphElementContainer, IHasTitle, IObjectClonedCallbackReceiver, ICopyPasteCallbackReceiver
    {
        ...
        public GraphModel AddLocalSubgraph(GraphModel localSubgraph)
        {
            if (!AllowSubgraphCreation)
                return null;
        ...
        /// </summary>
        protected void CheckGroupConsistency()
        {
        ...
        /// </summary>
        public PortWireIndex<WireModel> PortWireIndex => m_PortWireIndex ??= new PortWireIndex<WireModel>(WireModels);
        ...
        public void UpdateWire(WireModel wireModel, PortModel oldPort, PortModel port)
        {
        ...
        /// </summary>
        public IReadOnlyList<GraphModel> LocalSubgraphs => m_LocalSubgraphs;
        ...
        public NodePlaceholder CreateNodePlaceholder(string nodeName, Vector2 position, Hash128 guid, long referenceId = -1)
        {
        ...
        public ContextNodePlaceholder CreateContextNodePlaceholder(string nodeName, Vector2 position, Hash128 guid, IEnumerable<BlockNodeModel> blocks = null, long referenceId = -1)
        {
        ...
        public BlockNodePlaceholder CreateBlockNodePlaceholder(string nodeName, Hash128 guid, ContextNodeModel contextNodeModel, long referenceId = -1)
        {
        ...
        public VariableDeclarationPlaceholder CreateVariableDeclarationPlaceholder(string variableName, Hash128 guid, long referenceId = -1)
        {
        ...
        public PortalDeclarationPlaceholder CreatePortalDeclarationPlaceholder(string portalName, Hash128 guid, long referenceId = -1)
        {
        ...
        public WirePlaceholder CreateWirePlaceholder(PortModel toPort, PortModel fromPort, Hash128 guid, long referenceId = -1)
        {
            var existing = GetAnyWireConnectedToPorts(toPort, fromPort);
            if (existing != null)
        ...
        public GraphChangeDescription PushNewGraphChangeDescription()
        {
        ...
        public void PopGraphChangeDescription()
        {
