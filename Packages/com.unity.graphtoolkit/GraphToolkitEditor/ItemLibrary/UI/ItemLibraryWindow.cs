...
namespace Unity.GraphToolkit.ItemLibrary.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ItemLibraryWindow : EditorWindow
    {
        ...
        public ItemLibraryControl ItemLibraryControl => m_Control;
        public ItemLibraryLibrary Library => ItemLibraryControl.Library;
        ...
        public static ItemLibraryWindow Show(
            EditorWindow host,
