...
namespace Unity.GraphToolkit.ItemLibrary.Editor
{
    ...
    /// </summary>
    [UnityRestricted]
    public class ItemLibraryLibrary
    {
        ...
        public ItemLibraryPreferences Preferences { get; }
        ...
        public bool IsCollapsed(ICategoryView categoryView)
        {
        ...
        public void SetCollapsed(ICategoryView categoryView, bool setCollapsed = true)
        {
