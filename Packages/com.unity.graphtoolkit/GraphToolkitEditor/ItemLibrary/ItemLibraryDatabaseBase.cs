...
namespace Unity.GraphToolkit.ItemLibrary.Editor
{
    ...
    [Serializable]
    [UnityRestricted]
    public abstract class ItemLibraryDatabaseBase
    {
        /// <summary>
        ...
        public Dictionary<ItemLibraryItem, SearchData> LastSearchData { get; } = new Dictionary<ItemLibraryItem, SearchData>();
        ...
        public void OverwriteId(int newId)
        {
            Id = newId;
        }
